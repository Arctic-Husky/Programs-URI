...
// For some reason I couldn't get it to work on any of my IDEs, but it works perfectly on Repl.it (https://ColorfulHi.arctichusky.repl.run/ if you want to try it out)
void hicor(char c);
